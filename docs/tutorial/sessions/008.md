...
```sh
ls data/Template/21_ep2d_fid_basic_bold_p2_rest/dicom_series/ | wc -l
200
```
...
```sh
ls data/Template/21_ep2d_fid_basic_bold_p2_rest/dicom_series | tail -n5
0196.dcm
0197.dcm
0198.dcm
0199.dcm
...
```sh
ls data/008/21_ep2d_fid_basic_bold_p2_rest/dicom_series | tail -n5
0121.dcm
0122.dcm
0123.dcm
0124.dcm
